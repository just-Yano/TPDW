            ...
            <table style="border-collapse: collapse; width: 100%; border: 1px solid black;">
                ...
                <tbody>
                    <tr style="border: 1px solid black;" id = "ColumnData">
                        ...
                        <td style="border: 1px solid black; padding: 8px;"> 					
                            <img alt="flagOfTheCountry" height="40px" width="60px">
                                <xsl:attribute name="src">
                                    <xsl:value-of select="concat('http://www.geonames.org/flags/x/', translate(./country_codes/cca2, 'ABCDEFGHIJKLMNOPQRSTUVWXYZ', 'abcdefghijklmnopqrstuvwxyz'), '.gif')" />
                                </xsl:attribute>
					        </img>
                        </td>
                    </tr>
